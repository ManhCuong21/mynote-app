                    ...
                    when (event) {
                        ...
                        is SignUpSingleEvent.ValidationError.Email -> {
                            ...
                            binding.edtEmail.error = when {
                                SignUpUiState.SignUpValidationError.EMPTY_EMAIL in errors -> R.string.signup_email_empty_error
                                SignUpUiState.SignUpValidationError.INVALID_LENGTH_EMAIL in errors -> R.string.signup_email_length_error
                                SignUpUiState.SignUpValidationError.INVALID_FORMAT_EMAIL in errors -> R.string.signup_email_format_error
                                else -> R.string.signup_null_error
                            }.let { getString(it) }
                        }
                        ...
                        is SignUpSingleEvent.ValidationError.Password -> {
                            ...
                            binding.edtPassword.error = when {
                                SignUpUiState.SignUpValidationError.EMPTY_PASSWORD in errors -> R.string.signup_password_empty_error
                                SignUpUiState.SignUpValidationError.INVALID_LENGTH_PASSWORD in errors -> R.string.signup_password_length_error
                                else -> R.string.signup_null_error
                            }.let { getString(it) }
                        }
                        ...
                        is SignUpSingleEvent.ValidationError.PasswordConfirm -> {
                            ...
                            binding.edtPasswordConfirm.error = when {
                                SignUpUiState.SignUpValidationError.EMPTY_PASSWORD_CONFIRM in errors -> R.string.signup_password_empty_error
                                SignUpUiState.SignUpValidationError.INVALID_LENGTH_PASSWORD_CONFIRM in errors -> R.string.signup_password_length_error
                                SignUpUiState.SignUpValidationError.NOT_MATCH_PASSWORD_CONFIRM in errors -> R.string.signup_password_confirm_not_match_error
                                else -> R.string.signup_null_error
                            }.let { getString(it) }
                        }
                    }
