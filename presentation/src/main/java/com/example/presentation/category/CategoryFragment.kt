...
class CategoryFragment : BaseFragment(R.layout.fragment_category) {
    ...
    private fun setupInitialValues() = binding.apply {
        ...
        viewModel.dispatch(CategoryAction.SecurityCategoryChanged(state.securityCategory))
    }
    ...
    private fun setupInitCategory() = binding.apply {
        categoryModel?.let {
            ...
            viewModel.dispatch(CategoryAction.SecurityCategoryChanged(it.securityCategory))
        }
    }
    ...
    private fun handleSecurityClick() {
        ...
        if (hasPasswordOrBiometric) {
            ...
            mainNavigator.navigate(MainNavigator.Direction.CategoryFragmentToSecurityFragment)
        }
    }
