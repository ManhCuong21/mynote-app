package com.example.presentation.main.setting.compass.view
...
import com.example.presentation.databinding.CompassViewBinding
...
class CompassView(context: Context, attributes: AttributeSet) :
    ...
    init {
        ...
        binding = CompassViewBinding.inflate(layoutInflater, this)
    }
