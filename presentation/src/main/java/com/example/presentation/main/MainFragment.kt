...
//        isVisible = homeUIBottomNavVisible
        ...
        onItemSelected = {
            when (it) {
                ...
                2 -> navController.navigate(HomeFragmentDirections.actionGlobalToSearchFragment())
                3 -> navController.navigate(HomeFragmentDirections.actionGlobalToSettingFragment())
            }
