package com.example.presentation.biometric
...
import com.example.presentation.biometric.BiometricDialogFragment.Companion.BIOMETRIC_DIALOG_FRAGMENT_TAG
                    ...
                    binding.edtPassword.editText?.addTextChangedListener(object : TextWatcher {
                        ...
                        override fun onTextChanged(
                            ...
                            if (charSequence.isNotEmpty()) {
                                it.isEnabled = true // Bật button
                            } else {
                                it.isEnabled = false // Tắt button
                            }
                        }
