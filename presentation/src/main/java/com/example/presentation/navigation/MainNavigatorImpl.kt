...
import com.example.presentation.category.CategoryFragmentDirections
...
import com.example.presentation.note.image.ImageNoteFragmentDirections
...
private fun Direction.toNavDirections(): NavDirections = when (this) {
    ...
    is Direction.MainFragmentToCompassFragment -> MainFragmentDirections.actionMainFragmentToCompassFragment()
    ...
    is Direction.CategoryFragmentToSecurityFragment -> CategoryFragmentDirections.actionCategoryFragmentToSecurityFragment()
    is Direction.ImageNoteFragmentToEditImageNoteFragment -> ImageNoteFragmentDirections.actionImageNoteFragmentToEditImageNoteFragment(
        imagePath = imagePath
    )
