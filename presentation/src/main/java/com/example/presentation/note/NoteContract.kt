...
sealed interface NoteAction {
    ...
    data object DeleteDirectory : NoteAction
    data object DeleteDirectoryTemp : NoteAction
    ...
    data object GetListRecordNote : NoteAction
    data class DeleteRecordNote(val recordPath: String) : NoteAction
    ...
    data class SaveFileMediaToTemp(val noteModel: NoteModel) :
        NoteAction
}
...
data class NoteUiState(
    ...
    companion object {
        val INITIAL = NoteUiState(
            ...
            titleNote = null,
            contentNote = null,
            categoryNote = CategoryModel(-1, "", "icon_ex", false),
            directoryName = null,
            hasImage = null,
            hasRecord = null,
            colorTitleNote = null,
